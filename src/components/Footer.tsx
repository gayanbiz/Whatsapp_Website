...
export function Footer({ t }: FooterProps) {
  ...
  return (
    <footer className="bg-[#111111] px-4 py-5 text-white sm:px-6 lg:px-8">
      <div className="mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-3 text-sm sm:grid-cols-3">
        ...
        <a
          ...
          className="justify-self-center text-xs font-medium text-white/85 transition-colors hover:text-[#25D366] sm:justify-self-end"
        >
          {contact}
        </a>
      </div>
